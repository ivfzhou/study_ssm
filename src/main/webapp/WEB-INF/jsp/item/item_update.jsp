...
<form action="" method="">
    ...
    <table class="table table-hover">
        ...
        <tr class="success">
            ...
            <td>
                <input type="text" value="${item.productionDate}" class="form-control" name="productionDate"
                       id="productionDate" data-options="{'type':'YYYY-MM-DD','beginYear':2010,'endYear':2088}"
                       placeholder="请输入生产日期"/>
            </td>
        </tr>
        <tr class="warning">
